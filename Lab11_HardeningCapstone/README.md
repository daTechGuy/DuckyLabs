# Lab 11 — Close the Door: Preventing HID Injection

**This is the last lab, and the only one that's proactive instead of
reactive.** Labs 05–10 all answered "how do we catch this after it
...
- This policy is **class-wide**. A more surgical real-world control
  ...
  — Lab 10's discussion section mentioned this as the harder-to-deploy but
...
- Prevention and detection aren't a choice between one or the other. This
  ...
  allowed VID/PID) — which is exactly why Labs 05–10 still matter as a
  second layer.
...
Labs 07–10 took that into a real environment with real logs and real
persistence. This lab closes the loop: now that you know how the attack
works and how to catch it, you also know how to stop it at the door.
